    ...
    <header className="w-full fixed z-10">
      <nav className="w-full md:max-w-[500px] mx-auto flex justify-center items-center bg-slate-50 border border-gray-200 p-3 rounded-full shadow-md">
        <ul className="w-full flex justify-between items-center">
          <li
            className={`${
              pathname === "/#home" ? "bg-gray-100/80" : ""
            } text-blue-500 font-semibold hover:bg-gray-100/80  md:p-3 rounded-full transition duration-500`}
          >
            <Link
              href="#home"
          ...
          <li
            ...
            } text-blue-500 font-semibold hover:bg-gray-100  md:p-3 rounded-full transition duration-500`}
          >
            <Link
              href="#services"
              className="text-sm md:text-base flex gap-1 justify-center items-center"
