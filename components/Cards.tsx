...
const CardsProjects = ({ title, description, icon }: CardsProps) => {
  return (
    <div className="w-[350px] hover:-translate-y-3 transform transition duration-700 ease-in-out max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-xl dark:bg-gray-800 dark:border-gray-700">
